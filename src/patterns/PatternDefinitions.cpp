...
void PatternDefinitions::initializePatterns()
{
    ...
    createDualChamberPatterns();  // V-Contour dual-chamber patterns
...
// ============================================================================
// V-Contour Dual-Chamber Patterns
// ============================================================================

void PatternDefinitions::createDualChamberPatterns()
{
    // Dual-Chamber Engorgement + Oscillation Pattern
    PatternInfo dualEngorgement;
    dualEngorgement.name = "Dual-Chamber Engorgement";
    dualEngorgement.type = "dual_chamber";
    dualEngorgement.category = "Dual-Chamber";
    dualEngorgement.description = "Active engorgement via outer chamber + clitoral air-pulse oscillation (8-13 Hz)";
    dualEngorgement.basePressure = 40.0;
    dualEngorgement.intensity = 70.0;
    dualEngorgement.isValid = true;
    dualEngorgement.parameters["outer_pressure"] = 40.0;
    dualEngorgement.parameters["clitoral_frequency"] = 8.0;
    dualEngorgement.parameters["clitoral_amplitude"] = 40.0;
    dualEngorgement.parameters["engorgement_duration_ms"] = 30000;
    dualEngorgement.parameters["stimulation_duration_ms"] = 300000;
    dualEngorgement.parameters["cooldown_duration_ms"] = 30000;
    m_patterns["Dual-Chamber Engorgement"] = dualEngorgement;

    // Dual-Chamber Climax Pattern (higher frequency)
    PatternInfo dualClimax;
    dualClimax.name = "Dual-Chamber Climax";
    dualClimax.type = "dual_chamber";
    dualClimax.category = "Dual-Chamber";
    dualClimax.description = "Intense dual-chamber stimulation with 11 Hz oscillation for climax";
    dualClimax.basePressure = 50.0;
    dualClimax.intensity = 85.0;
    dualClimax.isValid = true;
    dualClimax.parameters["outer_pressure"] = 50.0;
    dualClimax.parameters["clitoral_frequency"] = 11.0;
    dualClimax.parameters["clitoral_amplitude"] = 55.0;
    dualClimax.parameters["engorgement_duration_ms"] = 20000;
    dualClimax.parameters["stimulation_duration_ms"] = 180000;
    dualClimax.parameters["cooldown_duration_ms"] = 45000;
    m_patterns["Dual-Chamber Climax"] = dualClimax;

    // Clitoral-Only Gentle Pattern
    PatternInfo clitoralGentle;
    clitoralGentle.name = "Clitoral Gentle";
    clitoralGentle.type = "clitoral_only";
    clitoralGentle.category = "Clitoral-Only";
    clitoralGentle.description = "Gentle clitoral oscillation without outer chamber vacuum";
    clitoralGentle.basePressure = 0.0;
    clitoralGentle.intensity = 50.0;
    clitoralGentle.isValid = true;
    clitoralGentle.parameters["frequency"] = 6.0;
    clitoralGentle.parameters["amplitude"] = 30.0;
    clitoralGentle.parameters["warmup_duration_ms"] = 30000;
    clitoralGentle.parameters["buildup_duration_ms"] = 60000;
    clitoralGentle.parameters["climax_duration_ms"] = 120000;
    clitoralGentle.parameters["afterglow_duration_ms"] = 30000;
    m_patterns["Clitoral Gentle"] = clitoralGentle;

    // Clitoral-Only Intense Pattern
    PatternInfo clitoralIntense;
    clitoralIntense.name = "Clitoral Intense";
    clitoralIntense.type = "clitoral_only";
    clitoralIntense.category = "Clitoral-Only";
    clitoralIntense.description = "Intense clitoral oscillation at optimal 10-12 Hz frequency";
    clitoralIntense.basePressure = 0.0;
    clitoralIntense.intensity = 80.0;
    clitoralIntense.isValid = true;
    clitoralIntense.parameters["frequency"] = 10.0;
    clitoralIntense.parameters["amplitude"] = 50.0;
    clitoralIntense.parameters["warmup_duration_ms"] = 20000;
    clitoralIntense.parameters["buildup_duration_ms"] = 45000;
    clitoralIntense.parameters["climax_duration_ms"] = 90000;
    clitoralIntense.parameters["afterglow_duration_ms"] = 25000;
